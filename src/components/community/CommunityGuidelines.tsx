...
export const CommunityGuidelines = () => (
  <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-indigo-100/50 shadow-sm">
    ...
    <ul className="text-sm text-indigo-800 space-y-3">
      <li className="flex items-start transition-all hover:translate-x-1 duration-200">

export default {
  ...
  mission: {
    ...
    education: {
      ...
      description: "Explaining techniques and Q&A by level"
    },
    global: {
  ...
  team: {
    ...
    members: {
      ...
      tsutsumi: {
        ...
        description: "Managing Partner at venture capital firm 'STRIVE', specializing in startup development support. Focuses on early-stage investments, supporting companies in Japan, Southeast Asia, and India. His philosophy is to 'sweat and fight alongside entrepreneurs', aiming to solve social issues."
      },
      tateishi: {
        name: "Shuya Tateishi",
  ...
  token: {
    ...
    discount: {
      title: "Registration Discount",
      description: "Token holders can register at a discounted price at any time."
    },
    content: {
      title: "Exclusive Content",
      description: "Access technique videos from top athletes and webinars."
    }
  },
  contact: {
    title: "Contact",
  ...
  whitepaper: {
    ...
    intro: {
      ...
      backgroundText: "Brazilian Jiu-Jitsu is growing globally both as a martial art and as a competitive sport. However, the community faces various challenges in terms of sustainable growth and fair value distribution.",
      overview: "Project Overview",
      overviewText: "JJFA (Jiu-Jitsu For ALL) aims to address these challenges by creating a decentralized platform that connects practitioners, dojos, and tournament organizers worldwide."
    }
  }
};

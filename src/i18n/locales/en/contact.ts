export const contact = {
  ...
  address: "Kudan Kaikan Terrace, 1-6-5 Kudanminami, Chiyoda-ku, Tokyo 102-0074",
  faq: {
    ...
    a3: "We have multiple locations worldwide. Please check our locations page for details.",
    q4: "How can I start training?",
    a4: "You can start by signing up for a trial class at one of our affiliated dojos."
  },
  form: {
    title: "Contact Form",
    name: "Name",

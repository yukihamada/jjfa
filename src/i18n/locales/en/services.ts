export const services = {
  ...
  jiueventpro: {
    description: "A comprehensive tournament management tool that streamlines event organization. Compatible with JiuFight, JJFA official tournaments, and existing competitions."
  },
  jiufight: {
